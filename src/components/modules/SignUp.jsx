    ...
    <div>
      <form onSubmit={handleSubmit}>
        <div className="flex justify-center items-center h-dvh bg-[#26313c] ">
          <div className=" px-4 py-2 mt-10 mx-4 w-80  bg-[#16202a] rounded-md lg:flex lg:w-full lg:px-0 lg:mx-20 2xl:mx-80   lg:rounded-xl overflow-hidden xl:shadow-2xl xl:shadow-blue-gray-900">
            <div className=" lg:w-6/12 lg:px-0 lg:flex lg:flex-col lg:items-center lg:justify-center">
              <div className=" text-center lg:text-left lg:w-72 xl:w-80 ">
                ...
                <p className=" text-gray text-xs opacity-80 mt-1 xl:text-sm">
                  See your growth and get consulting support!
                </p>
                <button className="  flex items-center justify-center px-5 py-2 text-white opacity-90 text-xs font-medium ring-1 ring-gray lg:ring-2  mt-4 w-full rounded-full xl:text-base bg-[#16202a] xl:px-0 xl:py-2">
                ...
                <div className="flex flex-col text-left mt-2">
                  ...
                  {error.confirmpassword && toch.confirmpassword ? (
                    <span className="text-gray text-xs p-1 bg-[#e11d48] font-bold rounded-lg inline-block w-52 mt-2">
                ...
                <button
                  onClick={notify}
                  type="submit"
                  className="w-full mt-4 bg-[#5d5fef] px-5 py-2 lg:ring-2 lg:ring-[#5d5fef] text-white opacity-90 text-xs font-medium rounded-full xl:text-lg xl:font-bold xlpx-6 xl:py-1"
                >
                  SignUp
                </button>
                <ToastContainer />
                <div className="w-full text-center mt-3">
                  <p className="text-gray text-sm font-semibold">
                    ...
                    <Link to="/login" className=" text-[#5d5fef]">
                      Login
                    </Link>
                  </p>
                </div>
            ...
            <div
              className="bg-cover bg-center w-6/12 hidden lg:block  rounded-bl-full rounded-tl-full shadow-lg "
              style={{
